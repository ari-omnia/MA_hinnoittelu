...
if (isset($_POST['login-submit'])) {
  ...
  if (empty($kayttajatunnus) || empty($salasana)) {
    header("Location: ../index.php?error=emptyfields&kayttajatunnus=".$kayttajatunnus);
    exit();
  }
  else {
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
      ...
      //  if ($salasana != $row['salasana']) {
        ...
        // ARI Poistettu toistaiseksi  else if ($pwdCheck == true) {
          ...
          $_SESSION['uid'] = $row['kayttajatunnus'];
          $_SESSION['email'] = $row['salasana'];
        ...
        header("Location: ../index.php?login=wronguidpwd.$kayttajatunnus.'/'.$salasana");
        exit();
      }
    }
  }
